<template>
  <div class="v-home">
    <div class="v-hone-header">
      <router-link to="/" class="v-home-header-logo">Study Notes</router-link>
      <div class="v-hone-header-content" />
      <a
        target="_blank"
        href="https://github.com/kitorv/study-notes"
        class="v-hone-header-github"
      >
        <svg
          t="1606136947439"
          class="icon"
...
.v-hone-header-content {
  flex: 1;
}

.v-hone-header-github {
